    ...
    <div className='relative bg-gradient-to-r from-pink-100 via-white to-white'>
      ...
      <div className='flex flex-col justify-center items-center py-10 md:ml-10 md:mr-10'>
        ...
        <div className='w-full md:flex md:flex-row-reverse '>
          <img className='mx-auto mt-1 w-72 md:w-1/3 z-10' src={imge2} alt='Our Mission' />
          <div className='md:w-2/3 mb-5 md:mt-32 z-10'>
        ...
        <div className='w-full z-10 md:flex mt-10'>
          <img className='absolute w-10 ml-0' src={imge4} alt='About Us' />
          <img className='mx-auto mt-1 w-72 md:w-1/3 z-10' src={imge3} alt='Our Vision' />
          <div className='md:w-2/3 mb-5 md:ml-20 md:mt-32 z-10'>
        ...
        <div className='w-full md:flex md:flex-row-reverse '>
          ...
          <div className='mb-5 md:mt-32 md:mr-20 z-10'>
        ...
        <h2 className='text-md md:text-2xl text-pText font-bold mt-5 md:mt-20 ml-7 text-start'>Our Team</h2>
        <p className='text-pText text-sm md:text-lg text-justify m-7 mt-0'>
        ...
        <div className='md:flex flex-wrap justify-between'>
          <Team
            ...
            role='Co-Founder'
            description='Beauty is a software developer, a machine learning expert and she has experience in the field of medicine.'
          />
          <Team
            image={melissa}
            name='Melissa Ncube'
            role='Co-Founder'
            description='Melissa is a software developer, a machine learning expert and she has experience in the field of medicine.'
          />
          <Team
            image={millicent}
            name='Millicent Malinga'
            role='Co-Founder'
            description='Millicent is a software developer, a machine learning expert and she has experience in the field of medicine.'
          />
        </div>
      </div>
    </div>
